    ...
    return (
        <header className="fixed top-0 left-0 right-0 z-50 p-4 sm:p-6 flex justify-between items-center bg-slate-100/50 dark:bg-slate-900/30 backdrop-blur-lg border-b border-black/10 dark:border-slate-500/20">
            ...
            <nav className="flex items-center gap-2 sm:gap-6">
                 <button onClick={() => navigate(Screen.Login)} className="font-semibold hover:text-purple-500 dark:hover:text-purple-300 transition-colors text-sm sm:text-base px-3 py-2 text-slate-800 dark:text-slate-200">
                    Log In
                </button>
