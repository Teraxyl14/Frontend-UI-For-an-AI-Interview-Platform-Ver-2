                ...
                <div className="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea
                            id="job-description"
                            rows={8}
                            className="block w-full rounded-md border-0 bg-slate-500/10 py-1.5 shadow-sm ring-1 ring-inset ring-slate-500/20 focus:ring-2 focus:ring-inset focus:ring-purple-500 sm:text-sm sm:leading-6 transition"
